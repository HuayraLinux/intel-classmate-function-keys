	...
	m_pCrrWnd(NULL), m_CrrTmr(0), m_CrrLvl(0)
{
	...
	m_pBrgBckGrn = gdk_pixbuf_new_from_file(
		"/usr/bin/fnkey/Images/Brightness_BG.png", NULL);
	m_pBrgLvl = gdk_pixbuf_new_from_file(
		"/usr/bin/fnkey/Images/Brightness_Level.png", NULL);
	m_pBrgLvlBln = gdk_pixbuf_new_from_file(
		"/usr/bin/fnkey/Images/Brightness_Level_Blank.png", NULL);
	m_pDspDual = gdk_pixbuf_new_from_file(
		"/usr/bin/fnkey/Images/Display_Dual.png", NULL);
	m_pDspVga = gdk_pixbuf_new_from_file(
		"/usr/bin/fnkey/Images/Display_External.png", NULL);
	m_pDspLcd = gdk_pixbuf_new_from_file(
		"/usr/bin/fnkey/Images/Display_LCD.png", NULL);
	m_pWrlOff = gdk_pixbuf_new_from_file(
		"/usr/bin/fnkey/Images/Wireless_Off.png", NULL);
	m_pWrlOn = gdk_pixbuf_new_from_file(
		"/usr/bin/fnkey/Images/Wireless_On.png", NULL);
